...
if gait == 'Trot':
    GaitConfig = {'overlap_time':0.2, 'swing_time':0.1, 'clearance_time':0.0, 'z_clearance':6}
    PuppyPose['x_shift'] = 2
    ...
    GaitConfig = {'overlap_time':0.2, 'swing_time':0.3, 'clearance_time':0.4, 'z_clearance':4}
